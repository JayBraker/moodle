...
$string['allowgcaptcha'] = 'Allow usage of Google reCaptcha';
...
$string['configallowgcaptcha'] = 'If set, allow managers to utilize Google reCaptcha blocks in this activity.';
